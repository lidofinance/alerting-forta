...
import { etherscanAddress, etherscanLink } from "./agent-reverted-tx";
...
export const createRevertedTxFinding = (
  ...
  return Finding.fromObject({
    ...
    description:
      `Reverted TX ${fromSelf ? "from" : "to"} the ${name} ${etherscanAddress(
        address,
      )} contract. ` + etherscanLink(txEvent.transaction.hash),
    alertId: "REVERTED-TX",
