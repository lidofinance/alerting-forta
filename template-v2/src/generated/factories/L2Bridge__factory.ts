...
export class L2Bridge__factory {
  static readonly abi = _abi
  static createInterface(): L2BridgeInterface {
    return new utils.Interface(_abi) as L2BridgeInterface
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider,
  ): L2Bridge {
    return new Contract(address, _abi, signerOrProvider) as L2Bridge
  }
}
