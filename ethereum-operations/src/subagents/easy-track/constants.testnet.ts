...
export const EASY_TRACK_TYPES_BY_FACTORIES = new Map<string, string>([
  ...
  ["0x785a8b1cdc03bb191670ed4696e9ed5b11af910a", "Add recipient (stETH)"],
  ["0xefea524d1739800ff6f7d2532ed4c8508220239a", "Remove recipient (stETH)"],
  ["0xf2f7fc1e8879c10d4579bc82d5fea923a5a228de", "Top up recipients (stETH)"],
]);
