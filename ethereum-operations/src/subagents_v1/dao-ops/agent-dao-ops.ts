...
import LIDO_DAO_ABI from "../../abi_v1/LidoDAO.json";
import MEV_ALLOW_LIST_ABI from "../../abi_v1/MEVBoostRelayAllowedList.json";
import ENS_BASE_REGISTRAR_ABI from "../../abi_v1/ENS.json";
