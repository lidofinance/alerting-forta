...
import * as agentEnsNames from "./subagents/ens-names/agent-ens-names";
import * as trpChanges from "./subagents/trp-changes/agent-trp-changes";
...
import * as treasurySwap from "./subagents/treasury-swap/treasury-swap";
