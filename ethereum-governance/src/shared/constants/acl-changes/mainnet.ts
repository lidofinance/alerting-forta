...
import {
  ...
  CSM_NODE_OPERATORS_REGISTRY_ADDRESS as csmNorAddress,
...
export const LIDO_APPS = new Map([
  ...
  [csmNorAddress, 'Node Operators Registry of CSM Module'],
...
export const LIDO_ROLES = new Map([
  ...
  ['0x75abc64490e17b40ea1e66691c3eb493647b24430b358bd87ec3e5127f1621ee', 'MANAGE SIGNING KEYS'],
])
    ...
    burnerAddress,
    {
      ...
      roles: new Map<INamedRole, string[]>([
        ...
        [
          ...
          [ROLES_OWNERS.lido, ROLES_OWNERS.curatedNor, ROLES_OWNERS.simpleDvtNor, ROLES_OWNERS.csmNor],
        ],
      ]),
    },
  ],
