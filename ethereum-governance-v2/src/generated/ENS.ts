...
export interface ENSInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'addController', values: [string]): string
  ...
  encodeFunctionData(functionFragment: 'reclaim', values: [BigNumberish, string]): string
  encodeFunctionData(functionFragment: 'register', values: [BigNumberish, string, BigNumberish]): string
  encodeFunctionData(functionFragment: 'registerOnly', values: [BigNumberish, string, BigNumberish]): string
...
export type ControllerAddedEvent = TypedEvent<[string], ControllerAddedEventObject>
...
export type ControllerRemovedEvent = TypedEvent<[string], ControllerRemovedEventObject>

export type ControllerRemovedEventFilter = TypedEventFilter<ControllerRemovedEvent>
...
export type NameMigratedEvent = TypedEvent<[BigNumber, string, BigNumber], NameMigratedEventObject>
...
export type NameRegisteredEvent = TypedEvent<[BigNumber, string, BigNumber], NameRegisteredEventObject>
...
export type NameRenewedEvent = TypedEvent<[BigNumber, BigNumber], NameRenewedEventObject>
...
export interface ENS extends BaseContract {
  ...
  functions: {
    ...
    addController(controller: string, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
    ...
    reclaim(id: BigNumberish, owner: string, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
    ...
    removeController(controller: string, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
    ...
    setResolver(resolver: string, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
  ...
  callStatic: {
    ...
    reclaim(id: BigNumberish, owner: string, overrides?: CallOverrides): Promise<void>

    register(id: BigNumberish, owner: string, duration: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>

    registerOnly(id: BigNumberish, owner: string, duration: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>

    removeController(controller: string, overrides?: CallOverrides): Promise<void>

    renew(id: BigNumberish, duration: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>
  ...
  filters: {
    ...
    'ControllerAdded(address)'(controller?: string | null): ControllerAddedEventFilter
    ControllerAdded(controller?: string | null): ControllerAddedEventFilter

    'ControllerRemoved(address)'(controller?: string | null): ControllerRemovedEventFilter
    ...
    NameMigrated(id?: BigNumberish | null, owner?: string | null, expires?: null): NameMigratedEventFilter
    ...
    NameRegistered(id?: BigNumberish | null, owner?: string | null, expires?: null): NameRegisteredEventFilter

    'NameRenewed(uint256,uint256)'(id?: BigNumberish | null, expires?: null): NameRenewedEventFilter
    NameRenewed(id?: BigNumberish | null, expires?: null): NameRenewedEventFilter
  ...
  estimateGas: {
    ...
    addController(controller: string, overrides?: Overrides & { from?: string }): Promise<BigNumber>
    ...
    reclaim(id: BigNumberish, owner: string, overrides?: Overrides & { from?: string }): Promise<BigNumber>
    ...
    removeController(controller: string, overrides?: Overrides & { from?: string }): Promise<BigNumber>

    renew(id: BigNumberish, duration: BigNumberish, overrides?: Overrides & { from?: string }): Promise<BigNumber>
    ...
    setApprovalForAll(to: string, approved: boolean, overrides?: Overrides & { from?: string }): Promise<BigNumber>

    setResolver(resolver: string, overrides?: Overrides & { from?: string }): Promise<BigNumber>
  ...
  populateTransaction: {
    ...
    addController(controller: string, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>

    approve(to: string, tokenId: BigNumberish, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>

    available(id: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>
    ...
    nameExpires(id: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>

    owner(overrides?: CallOverrides): Promise<PopulatedTransaction>

    ownerOf(tokenId: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>

    reclaim(id: BigNumberish, owner: string, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>
    ...
    removeController(controller: string, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>
    ...
    setResolver(resolver: string, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>
