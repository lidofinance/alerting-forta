...
export type StakingLimitSetEvent = TypedEvent<[BigNumber, BigNumber], StakingLimitSetEventObject>
...
export type StakingLimitRemovedEvent = TypedEvent<[], StakingLimitRemovedEventObject>

export type StakingLimitRemovedEventFilter = TypedEventFilter<StakingLimitRemovedEvent>
...
export type CLValidatorsUpdatedEvent = TypedEvent<[BigNumber, BigNumber, BigNumber], CLValidatorsUpdatedEventObject>

export type CLValidatorsUpdatedEventFilter = TypedEventFilter<CLValidatorsUpdatedEvent>

export interface DepositedValidatorsChangedEventObject {
  depositedValidators: BigNumber
}
export type DepositedValidatorsChangedEvent = TypedEvent<[BigNumber], DepositedValidatorsChangedEventObject>

export type DepositedValidatorsChangedEventFilter = TypedEventFilter<DepositedValidatorsChangedEvent>
...
export type LidoLocatorSetEvent = TypedEvent<[string], LidoLocatorSetEventObject>
...
export type ELRewardsReceivedEvent = TypedEvent<[BigNumber], ELRewardsReceivedEventObject>

export type ELRewardsReceivedEventFilter = TypedEventFilter<ELRewardsReceivedEvent>

export interface WithdrawalsReceivedEventObject {
  amount: BigNumber
}
export type WithdrawalsReceivedEvent = TypedEvent<[BigNumber], WithdrawalsReceivedEventObject>

export type WithdrawalsReceivedEventFilter = TypedEventFilter<WithdrawalsReceivedEvent>
...
export type EIP712StETHInitializedEvent = TypedEvent<[string], EIP712StETHInitializedEventObject>

export type EIP712StETHInitializedEventFilter = TypedEventFilter<EIP712StETHInitializedEvent>
...
export type TransferSharesEvent = TypedEvent<[string, string, BigNumber], TransferSharesEventObject>
...
export type SharesBurntEvent = TypedEvent<[string, BigNumber, BigNumber, BigNumber], SharesBurntEventObject>
...
export interface Lido extends BaseContract {
  ...
  functions: {
    ...
    receiveELRewards(overrides?: PayableOverrides & { from?: string }): Promise<ContractTransaction>
    ...
    getStakeLimitFullInfo(overrides?: CallOverrides): Promise<
      [boolean, boolean, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber] & {
    ...
    resumeStaking(overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
    ...
    receiveWithdrawals(overrides?: PayableOverrides & { from?: string }): Promise<ContractTransaction>
    ...
    transferToVault(arg0: string, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
    ...
    submit(_referral: string, overrides?: PayableOverrides & { from?: string }): Promise<ContractTransaction>
    ...
    removeStakingLimit(overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
    ...
    pauseStaking(overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
  ...
  callStatic: {
    ...
    finalizeUpgrade_v2(_lidoLocator: string, _eip712StETH: string, overrides?: CallOverrides): Promise<void>
    ...
    initialize(_lidoLocator: string, _eip712StETH: string, overrides?: CallOverrides): Promise<void>
  ...
  filters: {
    ...
    'EIP712StETHInitialized(address)'(eip712StETH?: null): EIP712StETHInitializedEventFilter
    EIP712StETHInitialized(eip712StETH?: null): EIP712StETHInitializedEventFilter
  ...
  estimateGas: {
    ...
    approve(_spender: string, _amount: BigNumberish, overrides?: Overrides & { from?: string }): Promise<BigNumber>
    ...
    receiveELRewards(overrides?: PayableOverrides & { from?: string }): Promise<BigNumber>
    ...
    resumeStaking(overrides?: Overrides & { from?: string }): Promise<BigNumber>

    getFeeDistribution(overrides?: CallOverrides): Promise<BigNumber>

    receiveWithdrawals(overrides?: PayableOverrides & { from?: string }): Promise<BigNumber>
    ...
    transferToVault(arg0: string, overrides?: Overrides & { from?: string }): Promise<BigNumber>
    ...
    submit(_referral: string, overrides?: PayableOverrides & { from?: string }): Promise<BigNumber>
    ...
    transfer(_recipient: string, _amount: BigNumberish, overrides?: Overrides & { from?: string }): Promise<BigNumber>
    ...
    removeStakingLimit(overrides?: Overrides & { from?: string }): Promise<BigNumber>
  ...
  populateTransaction: {
    ...
    stop(overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>
    ...
    receiveELRewards(overrides?: PayableOverrides & { from?: string }): Promise<PopulatedTransaction>
    ...
    resumeStaking(overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>

    getFeeDistribution(overrides?: CallOverrides): Promise<PopulatedTransaction>

    receiveWithdrawals(overrides?: PayableOverrides & { from?: string }): Promise<PopulatedTransaction>
    ...
    transferToVault(arg0: string, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>
    ...
    submit(_referral: string, overrides?: PayableOverrides & { from?: string }): Promise<PopulatedTransaction>
    ...
    removeStakingLimit(overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>
    ...
    getDepositableEther(overrides?: CallOverrides): Promise<PopulatedTransaction>

    sharesOf(_account: string, overrides?: CallOverrides): Promise<PopulatedTransaction>

    pauseStaking(overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>
