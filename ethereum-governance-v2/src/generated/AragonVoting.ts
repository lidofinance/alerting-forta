...
export interface AragonVotingInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'newVote(bytes,string)', values: [BytesLike, string]): string
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: 'newVote(bytes,string)', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'newVote(bytes,string,bool,bool)', data: BytesLike): Result
...
export type StartVoteEvent = TypedEvent<[BigNumber, string, string], StartVoteEventObject>
...
export type CastVoteEvent = TypedEvent<[BigNumber, string, boolean, BigNumber], CastVoteEventObject>
...
export type CastObjectionEvent = TypedEvent<[BigNumber, string, BigNumber], CastObjectionEventObject>
...
export type ChangeSupportRequiredEvent = TypedEvent<[BigNumber], ChangeSupportRequiredEventObject>
...
export type ChangeMinQuorumEvent = TypedEvent<[BigNumber], ChangeMinQuorumEventObject>
...
export type ChangeVoteTimeEvent = TypedEvent<[BigNumber], ChangeVoteTimeEventObject>
...
export type ChangeObjectionPhaseTimeEvent = TypedEvent<[BigNumber], ChangeObjectionPhaseTimeEventObject>

export type ChangeObjectionPhaseTimeEventFilter = TypedEventFilter<ChangeObjectionPhaseTimeEvent>
...
export interface AragonVoting extends BaseContract {
  ...
  functions: {
    ...
    forward(_evmScript: BytesLike, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
    ...
    executeVote(_voteId: BigNumberish, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
  ...
  getVote(
    ...
    [boolean, boolean, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber, string, number] & {
      open: boolean
      executed: boolean
      startDate: BigNumber
      snapshotBlock: BigNumber
  ...
  estimateGas: {
    ...
    unsafelyChangeVoteTime(_voteTime: BigNumberish, overrides?: Overrides & { from?: string }): Promise<BigNumber>
    ...
    forward(_evmScript: BytesLike, overrides?: Overrides & { from?: string }): Promise<BigNumber>
    ...
    executeVote(_voteId: BigNumberish, overrides?: Overrides & { from?: string }): Promise<BigNumber>
  ...
  populateTransaction: {
    ...
    forward(_evmScript: BytesLike, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>
    ...
    executeVote(_voteId: BigNumberish, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>
