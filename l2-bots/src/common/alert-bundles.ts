...
export type EventBundlesSheet =
 {
  [key: string]: {
    ...
    severity: FindingProto.Severity, // FindingSeverity,
    event: string,
...
export const eventBasedAlertBundleSheet: EventBundlesSheet = {
  'PROXY-UPGRADED': {
    ...
    severity: FindingProto.Severity.HIGH, // FindingSeverity.High,
  ...
  for (const [alertId, params] of Object.entries(eventBasedAlertBundleSheet)) {
    ...
    for (const contractAlias of contractsAliases) {
      ...
      result.push({
        ...
        type: FindingProto.FindingType.INFORMATION, // FindingType.Info,
        uniqueKey: "", // TODO
