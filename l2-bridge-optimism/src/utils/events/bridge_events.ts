...
export function getL2BridgeEvents(OPTIMISM_L2_TOKEN_GATEWAY: string, RolesMap: Map<string, string>): EventOfNotice[] {
  return [
    {
    ...
    },
    {
      ...
      name: 'ℹ️ Optimism L2 Bridge: Deposits Enabled',
...

    {
      ...
      name: 'ℹ️ Optimism L2 Bridge: Withdrawals Enabled',
