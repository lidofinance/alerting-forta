...
export const SELFOWNEDSTETHBURNER_ADDRESS = "0xb280e33812c0b09353180e92e27b8ad399b07f26";
...
export const DEPOSIT_SECURITY_MODULE = "0x710b3303fb508a84f10793c1106e32be873c24cd";
export const WSTETH_ADDRESS = "0x7f39c581f595b53c5cb19bd0b3f8da6c935e2ca0";
export const MEV_BOOST_RELAY_ALLOWED_LIST_ADDRESS = "0x7f39c581f595b53c5cb19bd0b3f8da6c935e2ca0";
export const ARAGON_VOTING_ADDRESS = "0x2e59A20f205bB85a89C53f1936454680651E618e";
export const ARAGON_TOKEN_MANAGER_ADDRESS = "0xf73a1260d222f447210581ddf212d915c09a3249";
export const ARAGON_FINANCE_ADDRESS = "0xb9e5cbb9ca5b0d659238807e84d0176930753d86";
export const LIDO_TREASURY_ADDRESS = "0x3e40d73eb977dc6a537af587d48316fee66e9c8c";
...
export const STORAGE_SLOTS: ContractStorageMap[] = [
  ...
  },
  {
    ...
    slots: [
      { name: "maxBurnAmountPerRunBasisPoints", address: "0x4" },
    ],
  },
  {
    contract: {
    ...
    slots: [
      { name: "lido.NodeOperatorsRegistry.lido" },
    ],
  },
  {
    contract: {
  ...
  },
  {
    ...
    slots: [
      ...
      { name: "supportRequiredPct, minAcceptQuorumPct, voteTime", address: "0x1" },
  ...
  },
  {
    ...
    slots: [
      { name: "designatedSigner", address: "0x1" },
    ],
  },
];
