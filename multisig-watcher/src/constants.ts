...
export const GNOSIS_SAFE_EVENTS_OF_NOTICE = [
  {
    ...
    description: (safeTx: SafeTX, args: Args) => `New owner ${args.owner} was added to ${getSafeLink(safeTx)}`,
  ...
  },
  {
    ...
    description: (safeTx: SafeTX, args: Args) => `Owner ${args.owner} was removed from ${getSafeLink(safeTx)}`,
    severity: FindingSeverity.Medium,
  },
  {
    ...
    description: (safeTx: SafeTX, args: Args) =>
  ...
  },
  {
    ...
    description: (safeTx: SafeTX, args: Args) => `Guard for ${getSafeLink(safeTx)} was changed to ${args.guard}`,
    severity: FindingSeverity.Medium,
  },
  {
  ...
  },
  {
    ...
    description: (safeTx: SafeTX, args: Args) => `Module ${args.module} was disabled for ${getSafeLink(safeTx)}`,
    severity: FindingSeverity.Medium,
  },
  {
    ...
    description: (safeTx: SafeTX, args: Args) => `Module ${args.module} was enabled for ${getSafeLink(safeTx)}`,
    severity: FindingSeverity.Medium,
  },
  {
...
function getSafeLink(safeTx: SafeTX): string {
  return `[${safeTx.safeName}](${BLOCKCHAIN_INFO[safeTx.blockchain].safeUrlPrefix}${safeTx.safeAddress})`
}
